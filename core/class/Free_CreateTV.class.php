...
class Free_CreateTV
{
    ...
    {
        log::add('Freebox_OS', 'debug', '[WARNING] - DEBUT CREATION DES COMMANDES POUR : ' . $logicalinfo['playerName']);
        ...
        log::add('Freebox_OS', 'debug', '[  OK  ] - FIN CREATION : ' . $logicalinfo['playerName']);
    }
}
