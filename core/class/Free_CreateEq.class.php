...
class Free_CreateEq
{
    ...
    private static function createEq_connexion_4G($logicalinfo, $templatecore_V4)
    {
        ...
        if ($result != false && $result != 'Aucun module 4G détecté') {
            ...
            $Connexion->AddCommand('Débit 4G Descendant', 'tx_use_rate_lte', 'info', 'numeric', $templatecore_V4 . 'badge', 'ko/s', null, 1, 'default', 'default', 0, null, 0, 'default', 'default',  24, '0', null, true, null, null, null, '#value# / 1000', '2');
            $Connexion->AddCommand('Débit 4G Montant', 'rx_used_rate_lte', 'info', 'numeric', $templatecore_V4 . 'badge', 'ko/s', null, 1, 'default', 'default', 0, null, 0, 'default', 'default',  25, '0', null, true, null, null, null, '#value# / 1000', '2');
