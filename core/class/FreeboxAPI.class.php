...
class FreeboxAPI
{
	...
	public function disques()
	{
		...
		if ($reponse['success']) {
			...
			foreach ($reponse['result'] as $Disques) {
				...
				$commande = $Disque->AddCommand('Occupation [' . $Disques['type'] . '] - ' . $Disques['id'], $Disques['id'], 'info', 'numeric', 'Freebox_OS::Freebox_OS_Disque', '%', '', 1, 'default', 'default', '', '', '', 'default', 'default', 'default', '', '0', '');
	...
	public function UpdateSystem()
	{
		try {
			...
			$Commande = $System->AddCommand('Update', 'update', 'action', 'other', '', '', '', 0, 'default', 'default', '', '', '', 'default', 'default', 'default', '', '0', '');
