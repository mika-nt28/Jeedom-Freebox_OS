    ...
    <div class="col-lg-2">
        <div class="bs-sidebar">
            <ul class="nav nav-list bs-sidenav">
                ...
                <li class="cursor li_Freebox_OS_Summary" data-href="rights"><a><i
                                class="fas fa-balance-scale-right"></i> {{Droits}}</a></li>
    ...
    <div class="col-lg-10" id="div_Freebox_IncludeDisplay">
                ...
                <form class="form-horizontal">
                    <fieldset>
                        <div class="form-group">
                            ...
                            <div class="col-md-4">
                                <input id="imput_freeboxIP" type="text" class="configKey form-control"
                                       data-l1key="FREEBOX_SERVER_IP"/>
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-md-5 control-label">{{Version de l'application Freebox serveur}}</label>
                            <div class="col-md-4">
                                <input id="imput_freeAppVersion" type="text" class="configKey form-control"
                                       data-l1key="FREEBOX_SERVER_APP_VERSION"/>
                            </div>
                        </div>
                        <div class="form-group">
        ...
        <div class="Freebox_OS_Display authentification" style="display:none;">
            ...
            <img class="img-responsive center-block"
                 src="plugins/Freebox_OS/core/images/authentification/authentification.jpg" height="600" width="600"/>
            <br/>
        ...
        <div class="Freebox_OS_Display rights" style="display:none;">
            ...
            <br/>
            <img class="img-responsive center-block"
                 src="plugins/Freebox_OS/core/images/authentification/modification_droit.png" height="500" width="500"/>
            <br/>
            <center>
        ...
        <div class="Freebox_OS_Display scan" style="display:none;">
            ...
            <div>
                <div id="colonne1">
                    <div class="thumbnail" style="box-shadow: 1px 1px 12px #872428; height: 310px;"><img
                                src="plugins/Freebox_OS/core/images/system.png" alt=""
                                style="border-radius:5px 5px 0 0; height: 100px;WIDTH: 100px">
                        <div class="caption">
                ...
                <div id="colonne2">
                    <div class="thumbnail" style="box-shadow: 1px 1px 12px #872428; height: 310px;"><img
                                src="plugins/Freebox_OS/core/images/parental.png" alt=""
                                style="border-radius:5px 5px 0 0; height: 100px;WIDTH: 100px">
                        <div class="caption">
                ...
                <div id="centre">
                    <div class="thumbnail" style="box-shadow: 2px 2px 12px #872428; height: 310px;"><img
                                src="plugins/Freebox_OS/core/images/homeadapters.png" alt=""
                                style="border-radius:5px 5px 0 0; height: 100px;WIDTH: 100px">
                        <div class="caption">
                            <h4>{{Mes Equipements Home - Tiles}}</h4>
                            <p></p>
                            <p class="text-center"><a class="btn bt_eqlogic_tiles">{{Scan des Tiles }} <i
                                            class="fas fa-search logoPrimary"></i></a></p>
                            <p></p>
        ...
        <div class="Freebox_OS_Display end" style="display:none;">
            ...
            <br/>
            <img class="img-responsive center-block" src="core/img/logo-jeedom-freebox-grand-nom-couleur.png"
